...
from lib.config import username, channelid_fish, wildchannelid, channelids, token, fishing, api
    ...
    async def on_message(self, message):
     ...
     if (message.channel.id == wildchannelid):
         ...
         if "incorrect response!" in message.content:
             ...
             await captcha(message, client, api)

         elif "continue" in message.content:
     ...
     for embed in embeds:
        ...
        await hunt(rarity, name, description, client)
